 ...
 * entities and tiles. Levels also implement {@link Updatable} and
 * {@link Renderable}<br>
...
public class Level implements Updatable, Renderable {
	...
	/**
	 * This is the only method that will work be successfully called when the
	 * level is unloaded, for obvious reasons.
	 * 
