...
public interface IShaderComponentPixel extends IShaderComponentBase {
	 ...
	 * @param sprite The sprite that contains all the color data.
	 * @param x The X of the sprite.
	 * @param y The Y of the sprite.
	 * @param vx The calculated view offset of the sprite, x.
	 * @param vy The calculated view offset of the sprite, y.
	 */
