...
public class RenderUtility
{
	...
	/**
	 * 
	 * Creates a new image, (<code>int[]</code>), out of a rectangle from a bigger
	 * image.
	 * 
	 * @param img
	 *            The bigger image.
	 ...
	 * @return The cut image. An integer array that is in the same format as the
	 *         specified <code>int[]</code>
	 */
