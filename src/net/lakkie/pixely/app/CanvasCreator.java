...
public class CanvasCreator {
	...
	/**
	 * Simplifies instantiating new {@link Canvas}'s. This specifies a device to display graphics with.<br>
	 * @param width The width of the canvas
	 * @param height The height of the canvas
	 * @param graphicDisplayer The graphics device. Used for settings.
